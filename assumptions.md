...
| K10 | Representation-level ablation of `control` reaches at least one E4.0 ASR band within the capability bound | design | E3.5 matching, E4.6 calibration reference | E2.3 | unverified | E3.5 compares on the dose-response curve; E4.6 uses the full-residual arm as its only calibration |
