...
| Model roster | 5–7 models, ≥4 families | *"one representative dense model and one representative MoE model"* initially | **Scoped for the first pass.** `main.tex`'s roster is the expansion target, which the scoped plan reaches at PEP-7 |
